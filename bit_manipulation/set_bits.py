...
class Solution:
    def hammingWeight(self, n: int) -> int:
        """number 1 = 1 in binary as well, hence we can do an and with 1 to
        check if the rightmost digit is 1 or not and add it to ans
        to move to the next binary digit, we can do a simply right shift
        operation and the new rightmost digit will be the next binary digit
